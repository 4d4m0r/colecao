    ...
    <form action="<?= base_url('/update_cultura') ?>" method="POST">
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <select name="id_meio" id="id_meio" class="form-control" required>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="restricao_cultura">Restrição Cultura</label>
                    <select class="form-control" id="restricao_cultura" name="restricao_cultura">
                        <option value="0" <?php echo ($cultura[0]['restricao_cultura'] == 0) ? 'selected' : ''; ?>>Não</option>
                        <option value="1" <?php echo ($cultura[0]['restricao_cultura'] == 1) ? 'selected' : ''; ?>>Sim</option>
                    </select>
                </div>
            </div>
        </div>
